...
exports.update = function (req, res) {
    //Update a product identified by the productId in the
    request
    Product.findById(req.params.productId, function (err,
        product) {
        if (err) {
            res.status(500).send({
                message: "Could not find a product with id " + req.params.productId
            });
        }
...
exports.delete = function (req, res) {
    //Detele a product with the specified productId in the
    request
